 ...
 **/
@Table(name = "tb_candy_cartoon_detail")
public class CandyCartoonDetail implements Serializable{

  @Id
  @GeneratedValue(strategy = GenerationType.IDENTITY)
  private String id;

  private String candyCartoonId; //candy_Cartoon的id
  ...
  public String getCandyCartoonId() {
    return candyCartoonId;
  }

  public void setCandyCartoonId(String candyCartoonId) {
    this.candyCartoonId = candyCartoonId;
  }
