 ...
 **/
@Table(name = "tb_candy_game_detail")
public class CandyGameDetail implements Serializable {

  @Id
  @GeneratedValue(strategy = GenerationType.IDENTITY)
  private String id;

  private String candyGameId; //candy_game的id
  ...
  public String getCandyGameId() {
    return candyGameId;
  }

  public void setCandyGameId(String candyGameId) {
    this.candyGameId = candyGameId;
  }
